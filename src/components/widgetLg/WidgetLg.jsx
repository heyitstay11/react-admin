            ...
            <table className="widgetLgTable">
                ...
                <tr className="widgetLgTr">
                    <td className="widgetLgUser">
                        ...
                        <span className="widgetLgName">Kurtis Crew</span>
                    </td>
                ...
                <tr className="widgetLgTr">
                    <td className="widgetLgUser">
                        ...
                        <span className="widgetLgName">Mike Johnson</span>
                    </td>
